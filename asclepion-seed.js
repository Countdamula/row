...
// tapping script says. asclepion-data.js is the file you edit
// when you want to change what a tapping script IS. Keeping them
// apart means the writing below never has to be scrolled past to
// read the machinery, and the machinery never has to be re-read
// to fix a typo.
//
// FIVE SECTIONS, NOT NINE. The journals, the example entry, the
// affirmation decks and the routines were cut on 2026-09-01 when
// the studio became one table. `S.feelings` stayed: it is the
// vocabulary the Movement rows are tagged with, not a section of
// its own.
//
